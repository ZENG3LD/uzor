...
mod tests {
    ...
    fn test_jet_svg_parses() {
        ...
        let jet_svg = crate::icons::aviation::JET;
    ...
    fn test_military_jet_svg_parses() {
        // Simple triangle SVG
        let mil_svg = crate::icons::aviation::MILITARY_JET;
    ...
    fn test_maki_airport_with_xml_entities() {
        ...
        let airport_svg = crate::icons::infrastructure::AIRPORT;
    ...
    impl crate::context::RenderContext for MockContext {
        fn dpr(&self) -> f64 { 1.0 }
        ...
        fn set_text_align(&mut self, _align: crate::types::TextAlign) { self.ops.push("set_text_align".to_string()); }
        fn set_text_baseline(&mut self, _baseline: crate::types::TextBaseline) { self.ops.push("set_text_baseline".to_string()); }
    ...
    fn test_draw_cloud_icon_produces_stroke_ops() {
        let mut ctx = MockContext::new();
        let cloud_svg = crate::icons::weather::CLOUD;
    ...
    fn test_all_maki_icons_with_xml_entities() {
        ...
        let icons = vec![
            ("AIRPORT", crate::icons::infrastructure::AIRPORT),
            ("HELIPORT", crate::icons::infrastructure::HELIPORT),
            ("FUEL", crate::icons::infrastructure::FUEL),
            ("HOSPITAL", crate::icons::infrastructure::HOSPITAL),
        ];
