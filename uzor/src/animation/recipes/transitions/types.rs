        ...
        match self {
            TransitionAnimation::SharedAxisX {
                ...
                timeline.add(
                    ...
                    crate::animation::timeline::Position::Absolute(Duration::ZERO),
                );
        ...
        match self {
            TransitionAnimation::SharedAxisX {
                ...
                timeline.add(
                    ...
                    crate::animation::timeline::Position::Absolute(Duration::from_millis(enter_start)),
                );
                timeline.add(
                    Duration::from_millis(*enter_duration_ms),
                    crate::animation::timeline::Position::Absolute(Duration::from_millis(enter_start)),
            ...
            TransitionAnimation::FadeThrough {
                ...
                timeline.add(
                    Duration::from_millis(*enter_duration_ms),
                    crate::animation::timeline::Position::Absolute(Duration::from_millis(*exit_duration_ms)),
                );
                timeline.add(
                    Duration::from_millis(*enter_duration_ms),
                    crate::animation::timeline::Position::Absolute(Duration::from_millis(*exit_duration_ms)),
            ...
            TransitionAnimation::StairCascade {
                ...
                for i in 0..5 {
                    ...
                    timeline.add(
                        ...
                        crate::animation::timeline::Position::Absolute(start_time + stagger_offset),
                    );
                }
            }
            TransitionAnimation::ParallaxSlide {
