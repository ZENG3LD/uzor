...
use crate::animation::{Decay, Easing, Spring, Timeline, Tween};
    ...
    pub fn enter_timeline(&self) -> Timeline {
        match self {
            ToastAnimation::SlideFade {
                ...
                timeline.add(tween.duration, crate::animation::timeline::Position::Absolute(Duration::ZERO));
                timeline
            }
            ...
            ToastAnimation::SpringBounce {
                ...
                timeline.add(duration, crate::animation::timeline::Position::Absolute(Duration::ZERO));
                timeline
            }
