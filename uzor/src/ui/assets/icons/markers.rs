...
/// Solid filled circle
///
/// Design: Plain filled disc using currentColor — no stroke, no outline
pub const CIRCLE_FILLED: &str = r#"<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" fill="currentColor"/></svg>"#;
