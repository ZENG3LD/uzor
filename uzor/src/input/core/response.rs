...
pub struct WidgetResponse {
    ...
    pub text_action: Option<crate::input::text::store::TextAction>,
}
...
mod tests {
    ...
    fn test_create_response_click() {
        let mut input = InputState::new();
        input.pointer.pos = Some((50.0, 50.0));
        input.pointer.clicked = Some(crate::input::pointer::state::MouseButton::Left);
    ...
    fn test_create_response_right_click() {
        let mut input = InputState::new();
        input.pointer.pos = Some((50.0, 50.0));
        input.pointer.clicked = Some(crate::input::pointer::state::MouseButton::Right);
