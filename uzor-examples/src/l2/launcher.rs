    ...
    fn render(&mut self) {
        ...
        let draw_left = |scene: &mut Scene,
         ...
         -> (Vec<f64>, InputResult) {
            ...
            uzor::framework::widgets::ctx::draw_button(
                ctx, &mut render,
            ...
            // ── 2. Close button ───────────────────────────────────────────────
            uzor::framework::widgets::ctx::draw_close_button(
                ctx, &mut render,
            ...
            // ── 3. Checkbox ───────────────────────────────────────────────────
            uzor::framework::widgets::ctx::draw_checkbox(
                ctx, &mut render,
            ...
            // ── 4. Toggle ─────────────────────────────────────────────────────
            uzor::framework::widgets::ctx::draw_toggle(
                ctx, &mut render,
            ...
            for (i, cx) in [28.0_f64, 68.0, 108.0].iter().enumerate() {
                ...
                uzor::framework::widgets::ctx::draw_radio(
                    ctx, &mut render,
            ...
            // ── 6. Slider ─────────────────────────────────────────────────────
            uzor::framework::widgets::ctx::draw_slider(
                ctx, &mut render,
            ...
            uzor::framework::widgets::ctx::draw_separator(
                ctx, &mut render,
            ...
            for (i, color) in swatch_colors.iter().enumerate() {
                ...
                uzor::framework::widgets::ctx::draw_color_swatch(
                    ctx, &mut render,
        ...
        let draw_right = |scene: &mut Scene, ctx: &mut ContextManager, hovered: &Option<String>| {
            ...
            for (i, lbl) in tab_labels.iter().enumerate() {
                ...
                uzor::framework::widgets::ctx::draw_tab(
                    ctx, &mut render,
            ...
            if active_tab == 0 {
                ...
                uzor::framework::widgets::ctx::draw_scrollbar(
                    ctx, &mut render,
                    "sb-track", "sb-thumb",
                    sb_track, sb_thumb,
                    5.0, &layer,
                ...
                for row in 0..CONTENT_ROWS {
                    ...
                    uzor::framework::widgets::ctx::draw_item(
                        ctx, &mut render,
        ...
        // ── Drag handle (splitter) — on top of both panels, no clip ──────────
        {
            ...
            let layer = LayerId::main();
            uzor::framework::widgets::ctx::draw_drag_handle(
